...
export const STOP = new Set(['school', 'academy', 'elementary', 'primary', 'high', 'collegiate', 'all', 'grade', 'the',
  'of', 'and', 'st', 'saint', 'memorial', 'regional', 'junior', 'senior', 'intermediate', 'middle', 'centre', 'center',
  'k', '12', 'nl'])

export const MAX_SIMILAR = 5

const keyOf = s => new Set(normName(s).split(' ').filter(w => w && !STOP.has(w)))
