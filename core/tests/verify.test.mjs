...
const glovertown = () => ({
  id: 'nlschools-status-2026-09-14-468-00000000',
...
test('other verbatim fields that fail become null (with dependants)', () => {
  const v = verifyNotice(
    {
      ...glovertown(),
      family_text: 'FOS 99',
      list_date_text: 'Tuesday, September 15, 2026',
      posted_text: 'SAMPLE 6:00 AM',
      posted_at: '2026-09-14T09:30:00Z',
    },
    raws,
  )
...
test('text notices: failed scope_evidence → district; failed phrase evidence → other', () => {
  ...
  const n = {
    ...
    source_text: 'SAMPLE All schools in the Central region are closed for the day',
    status: 'closed',
    status_basis: 'phrase',
    ...
    raw_refs: ['nlschools-notices/n.html'],
  }
