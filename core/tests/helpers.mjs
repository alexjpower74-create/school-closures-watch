...
export function healthyNls (now, patch = {}) {
  return {
    'nlschools-status': {
      id: 'nlschools-status', last_attempt_at: now, last_ok_at: now, last_result: 'ok',
      list_date: '2026-09-14', list_date_text: 'Monday, September 14, 2026', open_rule_quote: NLS_OPEN_RULE,
      ...patch
    },
